/*
 ...
 Source Server         : 121.5.251.250_3306
 Source Server Type    : MySQL
 Source Server Version : 50736
 Source Host           : 121.5.251.250:3306
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (2, '入网型号', 0, '入网型号', '', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (3, '机身颜色', 0, '机身颜色', '', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (4, '上市年份', 0, '上市年份', '', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (5, 'CPU品牌', 0, 'CPU品牌', '', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (6, 'CPU型号', 0, 'CPU型号', '', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (7, '机身长度（mm）', 0, '机身长度（mm）', '', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (8, '机身材质工艺', 0, '机身材质工艺', '', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (9, '颜色', 0, '颜色', '黑色;白色;蓝色', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (10, '内存', 0, '内存', '4GB;6GB;8GB;12GB', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (11, '版本', 0, '版本', '', 0, 1, 225, 0);
...
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1, 1, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (2, 2, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (3, 3, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (4, 4, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (5, 5, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (6, 6, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (7, 7, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (8, 8, 1, NULL);
...
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (1, '基本信息', 1, '基本信息', '基本信息', 225);
INSERT INTO `pms_attr_group` VALUES (2, '主体', 0, '主体', '主体', 225);
INSERT INTO `pms_attr_group` VALUES (3, '主芯片', 2, '主芯片', '主芯片', 225);
...
-- ----------------------------
INSERT INTO `pms_brand` VALUES (4, '华为', 'https://jhj-gilimall.oss-cn-hangzhou.aliyuncs.com/2022-06-01/2e399359-13a5-4ade-8bb9-92d528ae2042_huawei.png', '华为', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (5, '小米', 'https://jhj-gilimall.oss-cn-hangzhou.aliyuncs.com/2022-06-01/5f1c7377-6145-49e0-834e-d335114baf0a_xiaomi.png', '小米', 1, 'M', 1);
INSERT INTO `pms_brand` VALUES (6, 'oppo', 'https://jhj-gilimall.oss-cn-hangzhou.aliyuncs.com/2022-06-01/3adbfd02-f781-49f9-89c7-681f7dafc226_oppo.png', 'oppo', 1, 'O', 1);
INSERT INTO `pms_brand` VALUES (7, 'Apple', 'https://jhj-gilimall.oss-cn-hangzhou.aliyuncs.com/2022-06-01/8f0e96e6-4c91-4a13-8a00-72a18c34be8b_apple.png', '苹果', 1, 'A', 1);
...
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (3, 4, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (5, 5, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (6, 6, 225, 'oppo', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (7, 7, 225, 'Apple', '手机');
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (15, 4, 3, '机身颜色', '白色', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (16, 4, 7, '机身长度（mm）', '200', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (17, 4, 8, '机身材质工艺', '机身材质工艺', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (18, 4, 2, '入网型号', '520', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (19, 4, 4, '上市年份', '521', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (20, 4, 5, 'CPU品牌', '鸿蒙', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (21, 4, 6, 'CPU型号', '2757921', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (1, NULL, '华为50 黑色 4GB', NULL, 225, 4, '', '华为50 黑色 4GB', '', 5900.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (1, 1, 9, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 1, 10, '内存', '4GB', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (2, 4, NULL, 'https://jhj-gilimall.oss-cn-hangzhou.aliyuncs.com/2022-06-09//53f3f4f5-f091-4189-8ef8-c825b2fbacdf_1f15cdbcf9e1273c.jpg', NULL, NULL);
...
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (4, '华为50', '华为50', 225, 4, 0.1000, 0, '2022-06-09 03:08:59', '2022-06-09 03:08:59');
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (4, 'https://jhj-gilimall.oss-cn-hangzhou.aliyuncs.com/2022-06-09//81d71c36-b193-4fe9-8bde-d4072274e4fa_0d40c24b264aa511.jpg');
